        ...
        with (
            ...
            for _, t in enumerate(tqdm(timesteps)):
                ...
                noise_pred_cond = self.model(
                    latent_model_input, t=timestep, **arg_c,current_step=_, attn_mode="ti2v_t",cond_uncond = "cond")[0]
                noise_pred_uncond = self.model(
                    latent_model_input, t=timestep, **arg_null,current_step=_, attn_mode="ti2v_t",cond_uncond = "uncond")[0]
    ...
    def i2v(self,
        ...
        with (
            ...
            for _, t in enumerate(tqdm(timesteps)):
                ...
                noise_pred_cond = self.model(
                    latent_model_input, t=timestep, **arg_c,current_step=t, attn_mode="ti2v_i",cond_uncond = "cond")[0]
                if offload_model:
                    torch.cuda.empty_cache()
                noise_pred_uncond = self.model(
                    latent_model_input, t=timestep, **arg_null,current_step=t, attn_mode="ti2v_i",cond_uncond = "uncond")[0]
                if offload_model:
                    torch.cuda.empty_cache()
                noise_pred = noise_pred_uncond + guide_scale * (
                    noise_pred_cond - noise_pred_uncond)
